...
// Offer Letters
export const getOfferLetters = (params: { limit?: number; offset?: number; status?: string; excludeRejected?: boolean }) => api.get<ApiEnvelope<any>>('/api/v1/offer-letters', { params });
...
export const terminateOfferLetter = (id: string, data?: { effectiveAt?: string }) => api.post<ApiEnvelope<any>>(`/api/v1/offer-letters/${id}/terminate`, data || {});
